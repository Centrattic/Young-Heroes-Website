...
<main> 
    ...
    <form action = "../Backend/nominateScript.php" method="post" name="nominate" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <i>Please provide the following information about the hero you are nominating. If you are nominating a group, enter a group name and provide information here 
            about the first member of the group. There is room below for additional members.  </i>
            <br> <br>
