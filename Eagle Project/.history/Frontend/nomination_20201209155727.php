...
<main> 
    ...
    <head>
        ...
        <link href="../CSS/nomination.css?version=1" rel="stylesheet" type="text/css" />
...
*/
    ...
    <h3 style = "font-size: 1.25em; width: 60%; margin: 5px auto; font-weight: 800;"> All information is private and confidential for the use of the Community Service Award Committee only. </h3> <!-- until notification by the Community Service Award Committee of your finalist status.  and will only be shared with the Community Service Award Committee members. 
    ...
    <form action = "../Backend/nominateScript.php" method="post" name="nominate" enctype="multipart/form-data" >
        ...
        <fieldset>
            ...
            <i>Please provide the following information about the young hero you are nominating. If you are nominating a group, enter a group name and provide Nominee and Parent Information for
            the first member of the group. There is room below for additional members.  </i>
            <br> <br>
...
<!-- How many youth are you providing information about?-->
        ...
        <fieldset>
            ...
            <i> This information will only be viewed by the Community Service Award Committee, not the public. </i> 
            <br> <br>
        ...
        <fieldset>
            <legend> Additional Member Information </legend>
            <i> If you are nominating a group, provide information about up to 3 additional members of the group.</i>
            <br> <br>
        ...
        <fieldset>
            ...
            <i> This information will only be viewed by the Community Service Award Committee, not the public. </i> <br> <br>
                    <div class = "col-12">
        ...
        <fieldset>
            ...
            <br> <br>
            <div>
                <label for="workNominee"> Write about the work the young hero/group is/was doing. Please summarize the action they are/were taking, what prompted them to take such action, their goal, how they have/had engaged others in their efforts, and their impact. *</label>
