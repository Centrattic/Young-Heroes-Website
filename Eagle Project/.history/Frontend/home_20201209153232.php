...
<html>
  ...
  <?php
    ...
    <h2> We are now accepting nominations for 2021! The deadline is July 31st. </h2>
    ...
    <div id = "CSAChistory">
      <h2> The History of the CSAC + Youth Heroes </h2> <br>
      <p> The Millburn Township Community Service Award Committee (CSAC) has been working since 1991 to recognize “members of the community who have 
        generously given their time and who, through their volunteer activities, have enhanced the quality of life in the Township of Millburn 
        and the community at large.” Learn more about the committee and the community service awards<a href = "https://twp.millburn.nj.us/188/Community-Service-Award-Committee">here</a>. 
        <br> <br> Youth Heroes is a new initiative that builds on the CSAC’s mission statement by creating a separate award to recognize youth. It was inspired 
        and developed during COVID times by local Troop 19 Scout Riya Tyagi, who experienced the impact of the service work many youth had done to help alleviate 
        the effects of the pandemic. As part of her Eagle Scout Project, she decided to develop a Youth Heroes community service award and build this nomination website, 
        allowing the committee to discover more deserving candidates. The only requirement to be eligible for this award is to be a Millburn Township resident.
      </p>
    </div>
    ...
    <div id = "getinvolved">
          <div id = "nominateahero">
            ...
            <br>
              ...
              <h4> This is the first year that the Millburn CSAC will be accepting public nominations for the Community Service Awards.</h4>
                <p> Nominate a youth or adult in Millburn Township who you feel has completed profound service work and contributed to the quality of life in the Township. 
                This includes friends, children, parents, and more. Your nominee will receive the opportunity to share their work on this website! Any youth nominee will also 
                become a member of the inaugural class of Youth Heroes award winners. <br><br>
                The committee will be accepting nominations from January 1st to July 31st. The award will be given in the Fall.<p>      
               <h3>  2. Spread the Word </h3> <p>Share word of this incredible service opportunity with your family, friends, and classmates!</p>
    ...
    <p> If you have any questions or would like more information, contact Ms. Elaine Becker, the Chair of the Community Service Award Committee, at <a href = "mailto:elainebecker@comcast.net"> elainebecker@comcast.net.</a></p>
