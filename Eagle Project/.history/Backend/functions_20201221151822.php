                ...
                while($row = mysqli_fetch_array($result)){
                   ...
                   /* if ($type === "currentnominations") {
                    ...
                    if ($type === "currentwinners" || $type === "pastwinners") {
                        ...
                        if ($resumeNominee == "") {
                            $miscellaneousInfo = "<b> Miscellaneous:</b> <p> None</p>";
                        } else {
                            ...
                            <div class = 'heroGrid2'>
                                ...
                                <div class = 'media-item'>
                                    <b class = 'grid-title'> Hero's Media </b>  <br>
                                        $miscellaneousInfo<b> Miscellaneous: </b> <a class = 'sociallink' target = '_blank' href = '../Images/$resumeNominee'> Additional Info</a> <br>
                                        $facebookInfo<b> Facebook: </b> <a class = 'sociallink' target = '_blank' href = '$facebookNominee'>Facebook Link</a>  <br>
