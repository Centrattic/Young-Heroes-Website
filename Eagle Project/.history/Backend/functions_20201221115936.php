                ...
                while($row = mysqli_fetch_array($result)){
                   ...
                   /* if ($type === "currentnominations") {
                    ...
                    if ($type === "currentwinners" || $type === "pastwinners") {
                        ...
                        $memberInfo2 = "<tr> <td>$nameNominee2</td> <td>$emailNominee2</td>  <td>  $ageNominee2</td>  <td>$phoneParent1</td>";
                        $memberInfo3 = "<tr> <td>$nameNominee3</td> <td>$emailNominee3</td> <td>  $ageNominee3</td> <td>$phoneParent1</td>";
                        $memberInfo4 = "<tr> <td>$nameNominee4</td> <td>$emailNominee4</td> <td>  $ageNominee4</td> <td>$phoneParent1</td>";
