...
/*-----------------------------------------------------------------------------*/
      ...
      /*  if ($isYouth == 1) {
        ...
        groupName, nameNominee1, nameNominee2, nameNominee3, nameNominee4, ageNominee1, emailNominee1, 
        emailNominee2, emailNominee3, emailNominee4, gradeNominee1, schoolNominee1, nameParent1, emailParent1, phoneParent1, 
        nameNominator, emailNominator, phoneNominator, timeSubmission, headshotNominee, pic2Nominee, captionPic2, pic3Nominee, captionPic3, 
        workNominee, facebookNominee, instagramNominee, statusNominee, isYouth, yearNomination, resumeNominee
        ) 
