      ...
      /*  if ($isYouth == 1) {
        ...
        if ($isYouth == 1) {
            ...
            if(!mysqli_stmt_prepare($statement, $sqlquery)){
                ...
                mysqli_stmt_bind_param($statement, "sssssssssssssssssssssssssssiis", //ints are booleans, 1 if true, 0 if false
                $groupName, $nameNominee1, $nameNominee2, $nameNominee3, $nameNominee4, $ageNominee1, $emailNominee1, 
                $emailNominee2, $emailNominee3, $emailNominee4, $gradeNominee1, $schoolNominee1, $nameParent1, $emailParent1, $phoneParent1, 
                $nameNominator, $emailNominator, $phoneNominator, $timeSubmission, $headshotNominee, $pic2Nominee, $captionPic2, $pic3Nominee, $captionPic3, 
                $workNominee, $facebookNominee, $instagramNominee, $statusNominee, $isYouth, $yearNomination, $resumeNominee
            ...
            $sqlquery = "INSERT INTO nominations (
                groupName, nameNominee1, nameNominee2, nameNominee3, nameNominee4, ageNominee1, emailNominee1, 
                emailNominee2, emailNominee3, emailNominee4, phoneParent1, nameNominator, emailNominator, phoneNominator, 
                timeSubmission, headshotNominee, pic2Nominee, captionPic2, pic3Nominee, captionPic3, workNominee, facebookNominee, 
                instagramNominee, statusNominee, isYouth, yearNomination, resumeNominee
                ) 
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"; //need to bind params for placeholders to work // nameNominee is storing allinfo
            ...
            if(!mysqli_stmt_prepare($statement, $sqlquery)){
                ...
                //storing info in database (3 params of info)
                mysqli_stmt_bind_param($statement, "sssssssssssssssssssssssiis", //ints are booleans, 1 if true, 0 if false
                $groupName, $nameNominee1, $nameNominee2, $nameNominee3, $nameNominee4, $ageNominee1, $emailNominee1, 
                $emailNominee2, $emailNominee3, $emailNominee4, $phoneParent1, 
                $nameNominator, $emailNominator, $phoneNominator, $timeSubmission, $headshotNominee, $pic2Nominee, $captionPic2, $pic3Nominee, $captionPic3, 
                $workNominee, $facebookNominee, $instagramNominee, $statusNominee, $isYouth, $yearNomination, $resumeNominee
                );
                mysqli_stmt_execute($statement);
