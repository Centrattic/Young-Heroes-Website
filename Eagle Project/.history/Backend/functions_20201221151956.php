                ...
                while($row = mysqli_fetch_array($result)){
                   ...
                   /* if ($type === "currentnominations") {
                    ...
                    if ($type === "currentwinners" || $type === "pastwinners") {
                        ...
                        if ($facebookNominee == "") {
                            $facebookInfo = "<b> Facebook: </b> <p>None</p>";
                        } else {
                            $facebookInfo = "<b> Facebook: </b> <a class = 'sociallink' target = '_blank' href = '$facebookNominee'>Facebook Link</a>";
                        }

                        if ($instagramNominee == "") {
                            $instagramInfo = "<b> Facebook: </b> <p>None</p>";
                        } else {
                            $facebookInfo = "<b> Instagram: </b> <a class = 'sociallink' target = '_blank' href = '$instagramNominee'>Instagram Link </a>";
                        }
