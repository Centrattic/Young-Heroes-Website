                ...
                while($row = mysqli_fetch_array($result)){
                   ...
                   /* if ($type === "currentnominations") {
                    ...
                    if ($type === "currentwinners" || $type === "pastwinners") {
                        ...
                        $memberInfo2 = "<td>$gradeNominee2</td> <td>$schoolNominee2</td>";
                        $memberInfo3 = "<td>$gradeNominee3</td>  <td>$schoolNominee3</td>";
                        $memberInfo4 = "<td>$gradeNominee4</td> <td>$schoolNominee4</td>";
