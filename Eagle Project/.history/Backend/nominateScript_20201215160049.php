...
/*-----------------------------------------------------------------------------*/
        ...
        $ageNominee1 = $_POST['ageNominee1'];

        /*
        $ageNominee2 = $_POST['ageNominee2'];
        $ageNominee3 = $_POST['ageNominee3'];
        $ageNominee4 = $_POST['ageNominee4'];*/

        $gradeNominee1 = "Gr." . $_POST['gradeNominee1'] . ",";

        /*
        $gradeNominee2 = "Gr." . $_POST['gradeNominee2'] . ",";
        $gradeNominee3 = "Gr." .$_POST['gradeNominee3'] . ",";
        $gradeNominee4 = "Gr." .$_POST['gradeNominee4'] . ",";*/
        ...
        $schoolNominee2 = $_POST['schoolNominee2'];
        $schoolNominee3 = $_POST['schoolNominee3'];
        $schoolNominee4 = $_POST['schoolNominee4'];

        
        $nameParent2 = $_POST['nameParent2'];
        $nameParent3 = $_POST['nameParent3'];
        $nameParent4 = $_POST['nameParent4'];

        
        $emailParent2 = $_POST['emailParent2'];
        $emailParent3 = $_POST['emailParent3'];
        $emailParent4 = $_POST['emailParent4'];
        
        $phoneParent2 = $_POST['phoneParent2'];
        $phoneParent3 = $_POST['phoneParent3'];
        $phoneParent4 = $_POST['phoneParent4'];
        */
        ...
        /*$mediaRelease = $_POST['mediaRelease'];*/
        ...
        /*$bioNominee = $_POST['bioNominee'];*/

        $workNominee = $_POST['workNominee'];
        /*$twitterNominee = $_POST['twitterNominee'];
        $newsNominee = $_POST['newsNominee'];
        $websiteNominee = $_POST['websiteNominee'];*/
    ...
    $sqlquery = "INSERT INTO nominations (
        groupName, nameNominee1, nameNominee2, nameNominee3, nameNominee4, ageNominee1, ageNominee2, ageNominee3, ageNominee4, emailNominee1, 
        emailNominee2, emailNominee3, emailNominee4, gradeNominee1, gradeNominee2, gradeNominee3, gradeNominee4, schoolNominee1, schoolNominee2, schoolNominee3, schoolNominee4, nameParent1, nameParent2, 
        nameParent3, nameParent4, emailParent1, emailParent2, emailParent3, emailParent4, phoneParent1, phoneParent2, phoneParent3, phoneParent4, 
        nameNominator, emailNominator, phoneNominator, mediaRelease, timeSubmission, headshotNominee, pic2Nominee, captionPic2, pic3Nominee, captionPic3, bioNominee, 
        workNominee, twitterNominee, facebookNominee, instagramNominee, newsNominee, websiteNominee, statusNominee, isYouth, yearNomination, resumeNominee
        ) 
    ...
    if(!mysqli_stmt_prepare($statement, $sqlquery)){
        ...
        mysqli_stmt_bind_param($statement, "ssssssssssssssssssssssssssssssssssssissssssssssssiis", //ints are booleans, 1 if true, 0 if false
        $groupName, $nameNominee1, $nameNominee2, $nameNominee3, $nameNominee4, $ageNominee1, $ageNominee2, $ageNominee3, 
        $ageNominee4, $gradeNominee1, $gradeNominee2, $gradeNominee3, $gradeNominee4, $emailNominee1, $emailNominee2, $emailNominee3, $emailNominee4, $schoolNominee1, $schoolNominee2, 
        $schoolNominee3, $schoolNominee4, $nameParent1, $nameParent2, $nameParent3, $nameParent4, $emailParent1, $emailParent2,
        $emailParent3, $emailParent4, $phoneParent1, $phoneParent2, $phoneParent3, $phoneParent4, $nameNominator, $emailNominator, 
        $phoneNominator, $mediaRelease, $timeSubmission, $headshotNominee, $pic2Nominee, $Captionpic2Nominee, $pic3Nominee, $Captionpic3Nominee, $bioNominee, $workNominee,
        $twitterNominee, $facebookNominee, $instagramNominee, $newsNominee, $websiteNominee, $statusNominee, $isYouth, $yearNomination, $resumeNominee
        );
